...
async function indexMany(doc) {
    try {
        ...
        console.error(`Error during indexMany(). Tried to index doc-ID ${doc.id || '<blank>'}:`, error.response ? error.response.data : error.message);
    }
};

module.exports = indexMany;